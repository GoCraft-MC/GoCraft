...
//
//go:embed java/1.21.4/blocks.json java/1.21.4/items.json java/1.21.4/registries.json java/1.21.4/network_registries.json java/1.21.4/network_tags.json java/1.21.4/recipes.json java/1.21.4/block_loot.json java/1.21.4/fuels.json vanilla/1.21.4/item_definitions.json
var FS embed.FS
